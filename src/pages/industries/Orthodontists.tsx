          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <Card className="p-6 md:p-8 border-charcoal/10 hover:border-primary/20 transition-colors shadow-card">
              <div className="flex items-center mb-4">
                <Star className="w-5 h-5 fill-current" style={{ color: '#D91C5C' }} />
                <Star className="w-5 h-5 fill-current" style={{ color: '#D91C5C' }} />
                <Star className="w-5 h-5 fill-current" style={{ color: '#D91C5C' }} />
                <Star className="w-5 h-5 fill-current" style={{ color: '#D91C5C' }} />
                <Star className="w-5 h-5 fill-current" style={{ color: '#D91C5C' }} />
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-white decorative-circles">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
            ...
            <Card className="p-6 text-center border-charcoal/10 hover:border-primary/20 transition-colors shadow-card">
              <BarChart className="h-12 w-12 mx-auto mb-4" style={{ color: '#D91C5C' }} />
              <h3 className="text-lg sm:text-xl font-bold text-charcoal mb-3">
          ...
          <div className="space-y-8 md:space-y-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-xl sm:text-2xl font-bold text-charcoal mb-4">
                  <Crown className="w-6 h-6 inline mr-2" style={{ color: '#D91C5C' }} />
              ...
              <Card className="p-6 md:p-8 border-charcoal/10 shadow-card">
                <div className="flex items-center mb-4">
                  <DollarSign className="w-10 h-10 mr-3" style={{ color: '#D91C5C' }} />
                  <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <Card className="p-6 md:p-8 border-charcoal/10 shadow-card order-2 md:order-1">
                <div className="flex items-center mb-4">
                  <TrendingUp className="w-10 h-10 mr-3" style={{ color: '#D91C5C' }} />
                  <div>
              ...
              <div className="order-1 md:order-2">
                <h3 className="text-xl sm:text-2xl font-bold text-charcoal mb-4">
                  <Target className="w-6 h-6 inline mr-2" style={{ color: '#D91C5C' }} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-xl sm:text-2xl font-bold text-charcoal mb-4">
                  <Shield className="w-6 h-6 inline mr-2" style={{ color: '#D91C5C' }} />
              ...
              <Card className="p-6 md:p-8 border-charcoal/10 shadow-card">
                <div className="flex items-center mb-4">
                  <Award className="w-10 h-10 mr-3" style={{ color: '#D91C5C' }} />
                  <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <Card className="p-6 md:p-8 border-charcoal/10 shadow-card order-2 md:order-1">
                <div className="flex items-center mb-4">
                  <Users className="w-10 h-10 mr-3" style={{ color: '#D91C5C' }} />
                  <div>
              ...
              <div className="order-1 md:order-2">
                <h3 className="text-xl sm:text-2xl font-bold text-charcoal mb-4">
                  <Sparkles className="w-6 h-6 inline mr-2" style={{ color: '#D91C5C' }} />
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            <div>
              <h3 className="text-xl sm:text-2xl font-bold text-charcoal mb-4 sm:mb-6">
                Our Core Services
              </h3>
              <div className="space-y-2">
                <Link to="/seo-agency" className="block text-primary hover:underline">
                  <ArrowRight className="w-4 h-4 inline mr-2" />
                  SEO Agency
                </Link>
                <Link to="/ppc-agency" className="block text-primary hover:underline">
                  <ArrowRight className="w-4 h-4 inline mr-2" />
                  PPC Management Agency
                </Link>
                <Link to="/meta-ads-agency" className="block text-primary hover:underline">
                  <ArrowRight className="w-4 h-4 inline mr-2" />
                  Facebook Advertising Agency
                </Link>
                <Link to="/web-design-agency" className="block text-primary hover:underline">
                  <ArrowRight className="w-4 h-4 inline mr-2" />
                  Web Design Agency
                </Link>
                <Link to="/email-marketing-agency" className="block text-primary hover:underline">
                  <ArrowRight className="w-4 h-4 inline mr-2" />
                  Email Marketing Agency
                </Link>
              </div>

              <h3 className="text-xl sm:text-2xl font-bold text-charcoal mb-4 sm:mb-6 mt-8">
                Services by Location
              </h3>
              <div className="space-y-2">
                <Link to="/seo-sydney" className="block text-primary hover:underline">
                  <ArrowRight className="w-4 h-4 inline mr-2" />
                  SEO Sydney
                </Link>
                <Link to="/google-ads-melbourne" className="block text-primary hover:underline">
                  <ArrowRight className="w-4 h-4 inline mr-2" />
                  Google Ads Melbourne
                </Link>
                <Link to="/facebook-ads-hobart" className="block text-primary hover:underline">
                  <ArrowRight className="w-4 h-4 inline mr-2" />
                  Facebook Ads Hobart
                </Link>
                <Link to="/web-design-hobart" className="block text-primary hover:underline">
                  <ArrowRight className="w-4 h-4 inline mr-2" />
                  Web Design Hobart
                </Link>
              </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <Link to="/industries/cosmetic-dentists" className="block text-primary hover:underline">
                  <ArrowRight className="w-4 h-4 inline mr-2" />
                  Cosmetic Dentists Marketing
                </Link>
                <Link to="/industries/cosmetic-surgeons" className="block text-primary hover:underline">
                  <ArrowRight className="w-4 h-4 inline mr-2" />
                  Cosmetic Surgeons Marketing
                </Link>
                <Link to="/industries/real-estate-agents" className="block text-primary hover:underline">
                  <ArrowRight className="w-4 h-4 inline mr-2" />
                  Real Estate Agents Marketing
                </Link>
                <Link to="/industries/personal-injury-lawyers" className="block text-primary hover:underline">
                  <ArrowRight className="w-4 h-4 inline mr-2" />
                  Personal Injury Lawyers Marketing
                </Link>
                <Link to="/industries/plumbers" className="block text-primary hover:underline">
                  <ArrowRight className="w-4 h-4 inline mr-2" />
                  Plumbers Marketing
                </Link>
              </div>
