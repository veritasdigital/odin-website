...
import { Shield, Target, TrendingUp, Users, CheckCircle2, Award, Search, MousePointerClick, BarChart3, Mail, FileText, Zap, Lock, Lightbulb, Rocket, UserCheck, LineChart, Smartphone, MessageSquare, ArrowRight } from "lucide-react";
...
const InsuranceAgents = () => {
  ...
  const metrics = [{
    ...
    number: "250+",
    label: "Insurance Agencies Helped"
  }, {
    number: "95%",
    label: "Client Retention Rate"
  }, {
    number: "2.8x",
    label: "Average Lead Quality Increase"
  }];
  const problems = [{
    icon: Lock,
  ...
  const services = [{
    ...
    features: ["Long-form educational content (life insurance guides, policy comparison articles)", "Local SEO optimisation for 'insurance broker near me' searches", "Compliance-reviewed content that builds trust and authority", "Technical SEO for insurance-specific queries"]
  }, {
    ...
    features: ["Google Ads campaigns targeting life event triggers (marriage, home purchase, new baby)", "Meta Ads focused on specific demographics and behaviours", "Retargeting campaigns for policy renewal and upsell opportunities", "Lead quality scoring and CRM integration"]
  }, {
    icon: Smartphone,
    ...
    features: ["Trust-building design elements (client testimonials, credentials, awards)", "Interactive quote calculators and comparison tools", "Mobile-optimised responsive design", "Conversion-optimised landing pages for each insurance product"]
  }, {
    icon: Zap,
    ...
    features: ["HubSpot, Salesforce, or industry-specific CRM integration", "Automated email nurture sequences for different insurance products", "Lead scoring based on engagement and intent signals", "Pipeline reporting and attribution tracking"]
  }];
  ...
  const relatedLocations = [{
    ...
    name: "Google Ads Melbourne",
    url: "/google-ads-melbourne"
  }, {
    name: "Facebook Ads Hobart",
    url: "/facebook-ads-hobart"
  }, {
    name: "Web Design Hobart",
    url: "/web-design-hobart"
  }];
  const relatedIndustries = [{
    name: "Cosmetic Surgeons",
    url: "/industries/cosmetic-surgeons"
  }, {
    name: "Real Estate Agents",
    url: "/industries/real-estate-agents"
  }, {
    name: "Personal Injury Lawyers",
    url: "/industries/personal-injury-lawyers"
  }, {
    name: "Cosmetic Clinics",
    url: "/industries/cosmetic-clinics"
  }];
  const faqs = [{
  ...
  return <>
      ...
      <main className="min-h-screen">
        ...
        <section className="relative isolate overflow-hidden min-h-[70vh] flex items-center bg-white decorative-circles">
          ...
          <div className="absolute bottom-32 left-16 w-12 h-12 bg-accent/10 rounded-lg animate-float" style={{
          animationDelay: '2s'
        }}></div>
          <div className="absolute top-1/3 left-1/4 w-8 h-8 bg-secondary/10 rounded-full animate-float" style={{
          animationDelay: '4s'
        }}></div>
          
          <div className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-12 py-20 sm:py-24 lg:py-32 text-center flex flex-col items-center justify-center -ml-4 mr-12">
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex justify-center">
                <Button variant="default" size="lg" className="text-sm sm:text-base px-6 sm:px-8 py-4 sm:py-5 shadow-glow bg-[#D91C5C] hover:bg-[#D91C5C]/90" onClick={openForm}>
        ...
        <section className="py-12 sm:py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {problems.map((problem, index) => <Card key={index} className="p-4 sm:p-6 border-2 hover:border-primary/50 transition-colors">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-12 text-center">
            <div className="mb-6 sm:mb-8">
              <div className="flex justify-center mb-3 sm:mb-4">
                {[...Array(5)].map((_, i) => <Award key={i} className="w-4 h-4 sm:w-5 sm:h-5 text-yellow-500 fill-yellow-500" />)}
              </div>
            </div>
        ...
        <section className="py-12 sm:py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
            ...
            <div className="grid gap-4 sm:gap-6">
              {services.map((service, index) => <Card key={index} className="p-4 sm:p-6 hover:shadow-xl transition-shadow">
                  ...
                  <ul className="space-y-1.5 sm:space-y-2">
                    {service.features.map((feature, idx) => <li key={idx} className="flex items-start gap-2 text-xs sm:text-sm">
        ...
        <section className="py-12 sm:py-16 bg-muted/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
            ...
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
              {differentiators.map((item, index) => <Card key={index} className="p-4 sm:p-6 text-center hover:shadow-xl transition-shadow">
        ...
        <section className="py-12 sm:py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
            ...
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
              {process.map((step, index) => <Card key={index} className="p-4 sm:p-6 relative flex flex-col">
        ...
        <section className="py-12 sm:py-16 bg-gradient-to-br from-charcoal to-accent text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
            ...
            <div className="grid gap-6 sm:gap-8">
              {whyChoose.map((item, index) => <div key={index} className="flex gap-3 sm:gap-4">
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-primary to-secondary text-white text-center">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-12">
            ...
            <Button variant="secondary" size="lg" className="text-sm sm:text-base px-6 sm:px-8 py-4 sm:py-5 bg-white text-primary hover:bg-white/90" onClick={openForm}>
              Schedule Free Strategy Session
            </Button>
          </div>
        </section>
        ...
        <section className="py-12 sm:py-16 lg:py-20 pb-28 md:pb-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-12">
            ...
            <Accordion type="single" collapsible className="space-y-3">
              {faqs.map((faq, index) => <AccordionItem key={index} value={`item-${index}`} className="border rounded-lg px-4 sm:px-6">
        ...
        <div className="fixed bottom-0 left-0 right-0 p-4 bg-white border-t shadow-lg md:hidden z-50">
          <Button className="w-full bg-[#D91C5C] hover:bg-[#D91C5C]/90" size="lg" onClick={openForm}>
