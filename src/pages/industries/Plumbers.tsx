...
import { Wrench, TrendingUp, Target, Award, Search, MousePointerClick, Smartphone, Zap, Users, BarChart3, CheckCircle2, Shield, Clock, FileText, Rocket, Phone, MapPin, ArrowRight } from "lucide-react";
...
const Plumbers = () => {
  ...
  const metrics = [{
    ...
    number: "250+",
    label: "Plumbing Businesses Helped"
  }, {
    number: "95%",
  ...
  const services = [{
    ...
    features: ["Local SEO optimization for 'emergency plumber near me' searches", "Educational content library (blog posts, videos, FAQs)", "Google Business Profile optimization and review management", "Technical SEO for fast, mobile-friendly websites"]
  }, {
    ...
    features: ["Emergency job funnel (Google Search Ads for 'burst pipe,' 'blocked drain')", "Planned work funnel (Meta Ads targeting homeowners planning renovations)", "Call tracking and lead scoring to prioritize high-value jobs", "Retargeting campaigns for leads who didn't convert immediately"]
  }, {
    icon: Smartphone,
    ...
    features: ["Mobile-first responsive design (most searches are on mobile)", "Instant quote request forms and emergency contact buttons", "Client testimonials and before/after galleries", "Service area pages for local SEO ranking"]
  }, {
    icon: Zap,
    ...
    features: ["Call tracking to attribute phone leads to specific campaigns", "CRM integration (HubSpot, Jobber, ServiceTitan, or custom)", "Automated follow-up sequences for quote requests", "Job value tracking and ROI reporting"]
  }];
  ...
  const relatedIndustries = [{
    ...
    url: "/industries/insurance-agents"
  }];
  const faqs = [{
  ...
  return <>
      ...
      <div className="container mx-auto px-4">
        <Breadcrumbs items={[
          ...
          { label: "Plumbers", path: "/industries/plumbers" }
        ]} />
      </div>
      ...
      <main className="min-h-screen">
        ...
        <section className="py-10 md:py-12 lg:py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
            ...
            <div className="grid gap-4 md:gap-6">
              {problems.map((problem, index) => <Card key={index} className="p-4 md:p-6 border-2 hover:border-primary/50 transition-colors">
        ...
        <section className="py-12 sm:py-16 bg-muted/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
            ...
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
              {differentiators.map((item, index) => <Card key={index} className="p-4 sm:p-6 hover:shadow-xl transition-shadow">
        ...
        <section className="py-12 sm:py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
            ...
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
              {process.map((step, index) => <Card key={index} className="p-4 sm:p-6 flex flex-col">
        ...
        <section className="py-10 md:py-12 lg:py-16 bg-gradient-to-r from-primary to-secondary text-white text-center">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-12">
            ...
            <Button variant="secondary" size="lg" className="text-sm md:text-base px-6 md:px-8 py-4 md:py-5 bg-white text-primary hover:bg-white/90 w-full sm:w-auto" onClick={openForm}>
              Schedule Free Strategy Session
            </Button>
          </div>
        </section>
        ...
        <div className="fixed bottom-0 left-0 right-0 p-3 md:p-4 bg-white border-t shadow-lg md:hidden z-50">
          <Button className="w-full bg-[#D91C5C] hover:bg-[#D91C5C]/90 text-sm md:text-base" size="lg" onClick={openForm}>
