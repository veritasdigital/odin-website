    ...
    <>
      ...
      <main className="min-h-screen">
        ...
        <section className="relative isolate overflow-hidden min-h-[70vh] flex items-center justify-center bg-white decorative-circles">
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-20 sm:py-24 lg:py-32 text-center flex flex-col items-center ml-2 sm:ml-0">
            <nav className="mb-8 text-sm" aria-label="Breadcrumb">
              <ol className="flex flex-wrap items-center justify-center gap-2 text-muted-foreground">
                ...
                <li><ArrowRight className="w-4 h-4" /></li>
                <li className="text-foreground font-medium text-center">Architecture Firms</li>
              </ol>
            </nav>
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="hero-sub-headline text-base sm:text-lg md:text-xl font-semibold text-foreground/90 mb-6 leading-relaxed">
                Stop Relying on Unpredictable Referrals. Start Attracting High-Value Clients with Precision Digital Strategy.
              </p>

              <p className="text-sm sm:text-base md:text-lg text-muted-foreground mb-8 leading-relaxed max-w-3xl mx-auto">
              ...
              <p className="text-sm sm:text-base text-muted-foreground mb-8 leading-relaxed max-w-3xl mx-auto">
