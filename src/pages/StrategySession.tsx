...
import { Step13CommitmentQuestion } from "@/components/strategy-session/Step13CommitmentQuestion";
import { Step14FinalBooking } from "@/components/strategy-session/Step14FinalBooking";
...
const FormContent = () => {
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 13: return <Step13CommitmentQuestion />;
      case 14: return <Step14FinalBooking />;
