        ...
        <section className="relative isolate overflow-hidden py-12 md:py-32 px-4 bg-gradient-to-br from-white via-muted/30 to-muted/20">
          ...
          <div className="container mx-auto px-6 lg:px-12 relative z-10">
            <div className="max-w-4xl mx-auto text-center animate-slide-up">
              <h1 className="text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-black text-charcoal leading-tight tracking-tight mb-6 break-words animate-fade-in">
                Facebook Ads Services
              </h1>
              <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-charcoal/90 mb-8 leading-tight break-words animate-fade-in" style={{ animationDelay: '0.2s' }}>
