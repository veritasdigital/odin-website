          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-foreground mb-6 md:mb-8 leading-tight px-2">
                Full-service e-commerce solutions that drive results. We've helped over 250 businesses increase revenue by 340% through strategic optimisation, integrated marketing, and conversion-focused design.
              </p>
