...
export default function MarketingConsulting() {
  ...
  const painPoints = ["You're spending money on marketing tactics that aren't driving real results", "Your marketing efforts feel scattered and unfocused", "You're not sure which channels are actually profitable", "Your team lacks the strategic direction to achieve breakthrough growth", "You're falling behind competitors who seem to have it all figured out"];
  const features = ["Comprehensive marketing strategy development and roadmap creation", "In-depth competitive analysis and market positioning strategy", "Growth opportunity identification and prioritization framework", "Marketing budget allocation optimization and ROI analysis", "Team training and capability development programs", "Ongoing strategic support and quarterly business reviews", "Performance auditing and optimization recommendations", "Custom analytics dashboards and reporting systems", "Market research and customer persona development", "Scalable marketing systems and process documentation"];
  const benefits = [{
    icon: TrendingUp,
  ...
  const consultingAreas = [{
    ...
    challenges: ["Unclear revenue goals and growth targets", "No systematic approach to customer acquisition", "Marketing efforts don't align with business objectives", "Lack of scalable systems and processes"],
    solutions: ["Strategic growth roadmap development", "Revenue forecasting and planning", "Customer acquisition system design", "Scalable process documentation"]
  }, {
    title: "Digital Transformation Strategy",
    description: "Modernize your marketing approach to compete in today's digital landscape",
    challenges: ["Outdated marketing methods that no longer work", "Technology stack that doesn't integrate properly", "Team lacks digital marketing expertise", "Competitors are gaining digital advantages"],
    solutions: ["Digital marketing stack optimization", "Team training and skill development", "Technology integration planning", "Competitive digital strategy analysis"]
  }, {
    title: "Performance Optimization",
    description: "Identify and eliminate bottlenecks that prevent your marketing from reaching its potential",
    challenges: ["High marketing spend with low returns", "Don't know which channels are profitable", "Poor conversion rates across all campaigns", "Unable to scale successful campaigns"],
    solutions: ["Marketing ROI analysis and optimization", "Conversion rate improvement strategies", "Attribution modeling and tracking setup", "Scaling frameworks for winning campaigns"]
  }];
  const process = [{
    step: "01",
    ...
    details: ["Current marketing performance audit", "Competitive intelligence gathering", "Growth opportunity identification", "Resource and capability assessment"]
  }, {
    step: "02",
    title: "Custom Strategy Development",
    description: "We create a tailored marketing strategy that aligns with your business goals and market position.",
    details: ["Strategic roadmap creation", "Channel strategy and prioritization", "Budget allocation optimization", "KPI framework development"]
  }, {
    step: "03",
    ...
    details: ["Implementation timeline development", "Team training and workshops", "Process documentation creation", "Technology and tool recommendations"]
  }, {
    step: "04",
    title: "Ongoing Optimization & Support",
    description: "We provide continuous guidance, monitoring, and optimization to ensure sustained growth.",
    details: ["Monthly performance reviews", "Strategy adjustments and pivots", "Continuous optimization recommendations", "Quarterly strategic planning sessions"]
  }];
  const packages = [{
    ...
    features: ["Complete marketing performance audit", "Competitive analysis and benchmarking", "Strategic recommendations report", "90-day implementation roadmap", "One follow-up strategy session"],
    ...
    features: ["Monthly strategy sessions (2 hours each)", "Quarterly comprehensive reviews", "Team training and workshops", "Performance monitoring and optimization", "Direct access to senior strategists"],
    popular: true,
    ...
    features: ["Weekly strategic consultations", "Comprehensive strategic planning", "Team development and mentoring", "Board-level reporting and insights", "Priority access to specialized expertise"],
  ...
  const caseStudy = {
    ...
    timeframe: "6 months",
    results: ["463% increase in qualified leads", "287% improvement in customer acquisition cost", "152% increase in monthly recurring revenue", "Achieved product-market fit and scalable growth engine"],
  ...
  return <div className="min-h-screen bg-background">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 lg:px-12 w-full py-24 lg:py-32">
          <div className="max-w-4xl mx-auto space-y-8 lg:space-y-10 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <Button variant="hero" size="lg" className="text-lg px-12 py-6 shadow-glow" onClick={openForm}>
                Book Strategy Session
              </Button>
              <Button variant="secondary" size="lg" className="text-lg px-12 py-6 bg-white text-primary hover:bg-white/90 border-2 border-primary/20">
      ...
      <section className="py-24 bg-muted/30">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="space-y-12">
            {consultingAreas.map((area, index) => <Card key={index} className="p-8 hover:shadow-glow transition-all duration-300">
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <ul className="space-y-2">
                      {area.challenges.map((challenge, challengeIndex) => <li key={challengeIndex} className="flex items-start space-x-2">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {area.solutions.map((solution, solutionIndex) => <li key={solutionIndex} className="flex items-start space-x-2">
      ...
      <section className="py-24 bg-muted/30">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {packages.map((pkg, index) => <Card key={index} className={`p-8 hover:shadow-glow transition-all duration-300 ${pkg.popular ? 'ring-2 ring-primary' : ''}`}>
                {pkg.popular && <Badge className="mb-4 bg-primary text-primary-foreground">Most Popular</Badge>}
                <h3 className="text-2xl font-bold text-foreground mb-2">{pkg.name}</h3>
                <p className="text-primary font-semibold mb-4">{pkg.duration}</p>
                <p className="text-muted-foreground mb-6">{pkg.description}</p>
                
                <ul className="space-y-3 mb-6">
                  {pkg.features.map((feature, featureIndex) => <li key={featureIndex} className="flex items-start space-x-3">
                ...
                <Button variant={pkg.popular ? "cta" : "outline"} className="w-full" onClick={openForm}>
                  Get Started
                </Button>
              </Card>)}
          </div>
