          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-charcoal">
                Online Marketing Company Darwin
              </h1>
              <p className="text-xl md:text-2xl text-charcoal/90 mb-8 leading-relaxed">
                Stop Fragmenting Your Marketing. Get a Cohesive, Darwin-Centric Digital Strategy Engineered for Predictable Growth in the Northern Territory.
              </p>
              <Button 
                size="lg" 
