...
const WebDesignCanberra = () => {
  ...
  const relatedServices = [
    { name: "Google Ads Canberra", url: "/google-ads-canberra" },
    { name: "Facebook Ads Canberra", url: "/facebook-ads-canberra" },
    { name: "SEO Canberra", url: "/seo-canberra" },
  ...
  const relatedCities = [
    ...
    { name: "Web Design Gold Coast", url: "/web-design-gold-coast" }
  ];
