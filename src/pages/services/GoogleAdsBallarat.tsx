  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Local Google Ads Management for Ballarat businesses. Stop wasting budget on generic strategies. Get a FREE local audit and 540% average ROI." 
        />
