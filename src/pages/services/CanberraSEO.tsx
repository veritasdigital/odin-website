        ...
        <section className="relative py-20 md:py-32 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl">
              ...
              <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-4 max-w-3xl break-words">
              ...
              <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-10 max-w-3xl break-words">
