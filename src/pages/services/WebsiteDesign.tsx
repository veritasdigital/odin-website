  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-black mb-4 text-center text-charcoal">Calculate Your Potential Website ROI</h2>
          <p className="text-xl text-center text-charcoal/70 mb-12">See how much revenue a high-converting website could generate for your business.</p>
          <ROICalculator />
        </div>
      </section>
