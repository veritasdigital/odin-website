      ...
      <section className="relative pt-32 pb-20 overflow-hidden bg-gradient-to-br from-white via-muted/30 to-muted/20">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-xl md:text-2xl text-charcoal/70 mb-8 max-w-4xl mx-auto leading-relaxed animate-fade-in" style={{ animationDelay: '0.2s' }}>
            ...
            <p className="text-lg text-charcoal/60 mb-12 max-w-3xl mx-auto animate-fade-in" style={{ animationDelay: '0.3s' }}>
