  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <ServiceHero 
          h1="Adelaide Google Ads Agency: Stop Wasting Your Budget. Start Driving Sales."
          subheadline={
            <>
              <p className="text-xl md:text-2xl text-charcoal/90 mb-4">
                The PPC Agency Adelaide Businesses Trust for Maximum ROI and Zero Wasted Spend.
              </p>
              <p className="text-base md:text-xl text-charcoal/70 mb-6">
                Partner with Odin Digital and Turn Your Google Ads Budget into Verified Revenue.
              </p>
              <p className="text-sm md:text-lg text-charcoal/60 mb-8">
              ...
              <div className="mb-8">
                <Link to="/contact">
                  <Button size="lg" variant="cta" className="w-full md:w-auto">
                    Get Your FREE Adelaide PPC Strategy Session
              ...
              <div className="grid grid-cols-2 gap-6 max-w-2xl mx-auto">
                <div className="text-center">
                  <div className="text-4xl font-bold text-charcoal">$574M+</div>
                  <div className="text-sm text-charcoal/70">Client Revenue</div>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold text-charcoal">95%</div>
        ...
        <LocationContent city="Adelaide" serviceType="Google Ads" />
