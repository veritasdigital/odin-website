  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Stop wasting budget on Google Ads. Odin Digital is the PPC agency Hobart trusts for maximum ROI. Local expertise, seasonal optimization, and no lock-in contracts. Get your free audit." 
        />
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="text-center">
              <Button 
                onClick={openForm}
                size="lg"
                className="bg-[#D91C5C] hover:bg-[#D91C5C]/90 text-white shadow-primary transition-smooth text-xs sm:text-sm h-auto py-3 leading-snug whitespace-normal px-6"
              >
