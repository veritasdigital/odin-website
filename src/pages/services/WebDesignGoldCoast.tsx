...
const WebDesignGoldCoast = () => {
  ...
  const relatedServices = [{
    ...
    url: "/google-ads-gold-coast"
  }, {
    name: "Facebook Ads Gold Coast",
    url: "/facebook-ads-gold-coast"
  }, {
    name: "SEO Gold Coast",
    url: "/seo-gold-coast"
  }, {
      ...
      <div className="min-h-screen bg-background pb-20 md:pb-0">
        ...
        <section className="py-8 sm:py-12 md:py-16 px-4 sm:px-6 bg-muted/30">
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 lg:gap-8">
              ...
              return <div key={index} className="text-center space-y-2 p-4 sm:p-6 rounded-lg bg-card border border-border hover:shadow-lg transition-all duration-300">
        ...
        <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6">
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
              ...
              return <div key={index} className="p-4 sm:p-6 md:p-8 rounded-lg bg-card border border-border hover:border-primary hover:shadow-lg transition-all duration-300">
        ...
        <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 bg-muted/30">
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
              {testimonials.map((testimonial, index) => <div key={index} className="p-4 sm:p-6 md:p-8 rounded-lg bg-card border border-border hover:shadow-lg transition-all duration-300 flex flex-col">
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-6 bg-muted/30">
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
              ...
              return <div key={index} className="p-6 sm:p-8 rounded-lg bg-card border border-border hover:border-primary hover:shadow-lg transition-all duration-300">
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-6">
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-2 gap-6 sm:gap-8 relative">
              {processSteps.map((step, index) => <div key={index} className="p-6 sm:p-8 rounded-lg bg-card border border-border hover:border-primary hover:shadow-lg transition-all duration-300 relative">
                  ...
                  {index < processSteps.length - 1 && index % 2 === 0 && <ArrowRight className="hidden lg:block absolute top-1/2 -right-4 w-8 h-8 text-primary/30 -translate-y-1/2" />}
                </div>)}
            </div>
        ...
        <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6">
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="space-y-4 sm:space-y-6">
              {faqs.map((faq, index) => <div key={index} className="p-4 sm:p-6 rounded-lg bg-card border border-border hover:border-primary hover:shadow-lg transition-all duration-300">
