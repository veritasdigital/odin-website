...
const WebDesignHobart = () => {
  ...
  return <>
      ...
      <Helmet>
        ...
        <meta name="description" content="The performance-focused Web Design Hobart agency. Stop paying for pretty pictures and start investing in a sales machine. Get a proven 540% ROI website." />
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-6">
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
              ...
              return <div key={index} className="p-6 sm:p-8 rounded-lg bg-card border border-border hover:shadow-xl transition-all duration-300 hover:border-primary/50">
              ...
              <div className="p-8 rounded-lg bg-card border border-border shadow-lg flex flex-col justify-between h-full">
                <div>
                  <div className="flex items-start space-x-1 mb-4">
                    {[...Array(5)].map((_, i) => <Award key={i} className="w-5 h-5 text-primary fill-primary" />)}
                  </div>
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-6">
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              ...
              return <div key={index} className="p-6 rounded-lg bg-card border border-border hover:shadow-xl transition-all duration-300 hover:border-primary/50">
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-6 bg-muted/30">
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              ...
              return <div key={index} className="p-6 rounded-lg bg-card border border-border hover:shadow-xl transition-all duration-300">
                    <Icon className="w-10 h-10 sm:w-12 sm:h-12 text-primary mb-4" />
                    <h3 className="text-lg sm:text-xl font-bold text-foreground mb-3">
                      {diff.title}
                    </h3>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              {process.map((step, index) => <div key={index} className="relative">
                  ...
                  {index < process.length - 1 && <ArrowRight className="hidden lg:block absolute top-1/2 -right-4 w-8 h-8 text-primary/30 -translate-y-1/2" />}
                </div>)}
            </div>
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-6">
          <div className="container mx-auto max-w-4xl">
            ...
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.map((faq, index) => <AccordionItem key={index} value={`item-${index}`} className="border border-border rounded-lg px-6 bg-card">
