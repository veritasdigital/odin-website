...
import { 
  Target, TrendingUp, Shield, Zap, CheckCircle2, 
  BarChart, Award, Users, Clock, Layers, Eye, 
  DollarSign, TrendingDown, AlertCircle
} from "lucide-react";
import {
  Accordion,
  AccordionContent,
...
const OnlineMarketingCompanyGoldCoast = () => {
  ...
  const socialProof = [
    ...
    { number: "140+", label: "Businesses Helped" }
  ];
  ...
  const processSteps = [
    {
      ...
      tasks: [
        ...
        "Analyze your top 5 Gold Coast competitors",
    ...
    },
    {
      ...
      timeframe: "Week 2",
      tasks: [
        "Design your custom growth roadmap",
        "Set measurable KPIs and revenue targets",
        "Map out SEO, PPC, and social campaigns"
      ]
    },
    {
      number: "03",
      ...
      timeframe: "Week 3-4",
      tasks: [
        "Deploy optimized campaigns across all channels",
        "Implement advanced tracking and analytics",
        "Begin driving qualified traffic"
      ]
    },
    {
      number: "04",
  ...
  const relatedServices = [
    { name: "PPC Agency", link: "/ppc-agency" },
    { name: "SEO Agency", link: "/seo-agency" },
    { name: "Meta Ads Agency", link: "/meta-ads-agency" },
    { name: "Web Design Agency", link: "/web-design-agency" }
  ];

  const relatedLocations = [
    { name: "SEO Gold Coast", link: "/seo-gold-coast" },
    { name: "Google Ads Gold Coast", link: "/google-ads-gold-coast" },
    { name: "Facebook Ads Gold Coast", link: "/facebook-ads-gold-coast" },
    { name: "Web Design Gold Coast", link: "/web-design-gold-coast" }
  ];
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <ServiceHero
          h1="Online Marketing Company Gold Coast"
          subheadline={
            <>
        ...
        <div className="container mx-auto px-6 py-12">
          ...
          <section className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Explore Our Gold Coast Services
              </h2>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-3">
                  {relatedServices.map((service, index) => (
                    <li key={index}>
                      <Link to={service.link} className="text-primary hover:underline story-link">
                        {service.name}
                      </Link>
                    </li>
                  ))}
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4">Gold Coast Locations</h3>
                <ul className="space-y-3">
                  {relatedLocations.map((location, index) => (
                    <li key={index}>
                      <Link to={location.link} className="text-primary hover:underline story-link">
                        {location.name}
                      </Link>
                    </li>
                  ))}
