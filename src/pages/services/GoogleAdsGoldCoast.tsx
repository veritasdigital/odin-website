...
const GoogleAdsGoldCoast = () => {
  ...
  return <>
      ...
      <div className="min-h-screen bg-background">
        ...
        {/* Hero Section */}
        <section className="pt-28 pb-20 md:py-32 px-4 relative overflow-hidden bg-gradient-to-br from-white via-muted/30 to-muted/20">
          ...
          <div className="container mx-auto max-w-6xl relative z-10">
            <div className="text-center space-y-8">
              <h1 className="text-4xl md:text-5xl font-bold leading-tight drop-shadow-lg animate-fade-in text-slate-950 lg:text-6xl">
                Google Ads Agency Gold Coast
              </h1>
              <p style={{
              animationDelay: '0.1s'
            }} className="text-2xl md:text-3xl font-semibold leading-snug drop-shadow-md animate-fade-in text-slate-950 lg:text-4xl">
                Stop Settling for Tire-Kickers. Get High-Value Leads with a 540% Average ROI.
              </p>
              <div className="max-w-4xl mx-auto space-y-6 text-lg text-white/95 drop-shadow animate-fade-in" style={{
              animationDelay: '0.2s'
            }}>
              ...
              <Button size="xl" onClick={openForm} variant="cta" className="shadow-xl hover:shadow-2xl transition-all duration-300 text-base sm:text-lg md:text-xl px-6 sm:px-8 md:px-12 py-4 sm:py-5 md:py-6 h-auto min-h-[3.5rem] whitespace-normal leading-snug animate-fade-in" style={{
              animationDelay: '0.3s'
            }}>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="p-8 space-y-6">
                ...
                <Button variant="outline" onClick={openForm} className="w-full text-sm sm:text-base px-4 sm:px-6 py-3 sm:py-4 h-auto min-h-[3rem] whitespace-normal leading-snug">
        ...
        <section className="py-20 px-4 bg-gradient-to-br from-primary/10 to-secondary/10">
          <div className="container mx-auto max-w-4xl text-center space-y-8">
            ...
            <Button size="xl" onClick={openForm} className="bg-[#D91C5C] hover:bg-[#D91C5C]/90 text-white shadow-lg hover:shadow-xl transition-all duration-300 text-base sm:text-lg md:text-xl px-6 sm:px-8 md:px-12 py-4 sm:py-5 md:py-6 h-auto min-h-[3.5rem] whitespace-normal leading-snug">
              Get Your FREE Gold Coast PPC Strategy Audit <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
          </div>
        </section>
        ...
        <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 md:hidden px-4 w-full max-w-md">
          <Button size="lg" onClick={openForm} className="w-full bg-[#D91C5C] hover:bg-[#D91C5C]/90 text-white shadow-lg text-sm sm:text-base px-4 sm:px-6 py-3 sm:py-4 h-auto min-h-[3rem] whitespace-normal leading-snug">
