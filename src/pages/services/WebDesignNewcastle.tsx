...
const WebDesignNewcastle = () => {
  ...
  const relatedServices = [{
    name: "Google Ads Newcastle",
    url: "/google-ads-newcastle"
  }, {
    name: "SEO Newcastle",
    url: "/seo-newcastle"
  }, {
  ...
  return <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="relative isolate overflow-hidden min-h-screen flex items-center bg-white">
          ...
          <div className="absolute bottom-20 right-10 w-80 h-80 bg-muted/15 rounded-full blur-3xl animate-pulse" style={{
          animationDelay: '1s'
        }} />
          <div className="absolute top-1/2 left-1/3 w-48 h-48 bg-muted/10 rounded-full blur-2xl animate-pulse" style={{
          animationDelay: '2s'
        }} />
            ...
            <div className="grid grid-cols-1 gap-16 lg:gap-20 items-center min-h-screen py-24 lg:py-32">
              ...
              <div className="space-y-8 lg:space-y-10 animate-slide-up max-w-2xl mx-auto text-center">
                ...
                <div className="pt-2 flex justify-center">
                  <Button variant="hero" size="lg" className="text-lg px-12 py-6 shadow-glow whitespace-normal break-words" onClick={openForm}>
        ...
        <section className="py-20 md:py-32 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-3 gap-4 md:gap-8 max-w-4xl mx-auto">
              ...
              return <Card key={index} className="p-6 text-center hover-scale border-border/50 bg-card">
        ...
        <section className="py-6 sm:py-8 md:py-12 lg:py-16 xl:py-24 px-4 sm:px-6 bg-muted/30">
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 md:gap-4 lg:gap-6">
              ...
              return <div key={index} className="p-3 sm:p-4 md:p-5 lg:p-6 rounded-lg bg-card border border-border hover:border-primary hover:shadow-lg transition-all duration-300">
        ...
        <section className="py-6 sm:py-8 md:py-12 lg:py-16 xl:py-24 px-4 sm:px-6 bg-muted/30">
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3 md:gap-4 lg:gap-6">
              ...
              const Icon = item.icon;
              return <div key={index} className="p-3 sm:p-4 md:p-6 rounded-lg bg-card border border-border hover:border-primary hover:shadow-lg transition-all duration-300">
        ...
        <section className="py-6 sm:py-8 md:py-12 lg:py-16 xl:py-24 px-4 sm:px-6">
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="space-y-2 sm:space-y-3 md:space-y-4">
              {faqs.map((faq, index) => <div key={index} className="rounded-lg bg-card border border-border overflow-hidden">
                  <button onClick={() => setOpenFaq(openFaq === index ? null : index)} className="w-full p-3 sm:p-4 md:p-5 lg:p-6 text-left flex items-center justify-between hover:bg-muted/50 transition-colors">
                  ...
                  {openFaq === index && <div className="px-3 sm:px-4 md:px-5 lg:px-6 pb-3 sm:pb-4 md:pb-5 lg:pb-6">
                      <p className="text-xs sm:text-sm md:text-base text-muted-foreground">
                        {faq.answer}
                      </p>
                    </div>}
