...
const GoogleAdsBrisbane = () => {
  ...
  const schemaMarkup = {
    ...
    "@id": "https://odindigital.com.au/google-ads-brisbane#professionalservice",
    "name": "Google Ads Management Brisbane",
    ...
    "url": "https://odindigital.com.au/google-ads-brisbane",
    "provider": {
  ...
  return <>
        ...
        <section className="py-12 md:py-20">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 max-w-6xl mx-auto mb-10">
              ...
              return <Card key={index} className="p-6 md:p-8 hover:shadow-glow transition-all duration-300">
        ...
        <section className="py-12 md:py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 max-w-7xl mx-auto mb-10">
              ...
              return <Card key={index} className="p-6 hover:shadow-glow transition-all duration-300">
                    <Icon className="w-10 h-10 md:w-12 md:h-12 text-[#D91C5C] mb-4" />
        ...
        <section className="py-12 md:py-16 lg:py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mt-8 md:mt-12">
              <Button onClick={openForm} size="lg" className="bg-[#D91C5C] hover:bg-[#D91C5C]/90 text-white shadow-primary transition-smooth w-full sm:w-auto text-sm md:text-base px-4 md:px-6 lg:px-8 py-4 md:py-5 whitespace-normal break-words text-center leading-tight">
        ...
        <section className="py-12 md:py-16 lg:py-20 gradient-hero">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <Button onClick={openForm} size="xl" className="bg-[#D91C5C] hover:bg-[#D91C5C]/90 text-white text-sm md:text-base lg:text-lg px-4 md:px-8 lg:px-12 py-4 md:py-5 lg:py-6 shadow-primary transition-smooth w-full sm:w-auto leading-tight">
      ...
      {showStickyButton && <div className="fixed bottom-0 left-0 right-0 z-50 p-3 bg-white shadow-lg md:hidden border-t border-border">
          <Button onClick={openForm} className="w-full bg-[#D91C5C] hover:bg-[#D91C5C]/90 text-white shadow-primary text-sm py-5">
